...
import { CategorySectionComponent } from './category-section.component'; // ✅ Correct import
...
describe('CategorySectionComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [CategorySectionComponent] // ✅ Use declarations for normal components
    }).compileComponents();
